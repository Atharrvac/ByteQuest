...
public class mySecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
				.csrf().disable()
				.authorizeRequests()
				.antMatchers("/index", "/register", "/js/**", "/css/**", "/fonts/**", "/images/**", "/inc/**",
						"/scss/**", "/plugins/**", "/templates/register", "/SweetAlert/**", "/Register", "/error",
						"/forgotpassword/**", "/news", "/contact", "/sendemail", "/videos/**", "/getGraphData/**",
						"/verify/**")
				.permitAll()
				.antMatchers("/public/**", "/vote/**").hasRole("USER")// only people with role user can access these
																		// pages
