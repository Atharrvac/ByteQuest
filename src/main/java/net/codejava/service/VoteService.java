...
public class VoteService {
    ...
    // * Block secondPartyBlock = new
    // Block(initialSecondPartyValues,secondPartyHash);
    ...
    // int blockHash = Arrays.hashCode(new int[] {
    // Arrays.hashCode(temp.getTransaction()), prevHash });
    ...
    // transaction[2] = "BJP";
    // blockHash = Arrays.hashCode(new int[] { Arrays.hashCode(transaction),
    // prevHash });
    // if (blockHash == temp.getBlockHash()) {
    // BJP++;
