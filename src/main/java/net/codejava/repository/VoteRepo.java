...
public interface VoteRepo extends JpaRepository<Votedata, String> {
	...
	@Query(value = "SELECT * FROM votedata ORDER BY date DESC LIMIT 1", nativeQuery = true)
	...
	public void copyData(@Param("username") String username, @Param("currhash") String currhash,
			@Param("date") Date date, @Param("prevhash") String prevhash);
	// public Votedata copyData(String username,String currhash, Date date, String
	// prevhash);
